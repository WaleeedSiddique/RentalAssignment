...
{
    public partial class newuserseeded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleColour = table.Column<int>(type: "int", nullable: false),
                    OwnerName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OwnerPhone = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: true),
                    ChassisNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VehicleType = table.Column<int>(type: "int", nullable: false),
                    sittingCapacity = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentalPhone = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "Adminkahsakjsajkf99s86as79", "admin8472850237", "Admin", "ADMIN" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "Admin2729083033937898-329332nduyvugjvjhf8e4", 0, "f8bf78b4-c91b-4795-a08a-6eefd5eed2a4", "Admin@gmail.com", true, true, false, null, "ADMIN@GMAIL.COM", "ADMIN", "AQAAAAEAACcQAAAAEFnt5YmCRtOBM1JYD3kxeYEBa/iKz5EsSK0KoSS85Yid7/abFOVV8eeXgx3O3/IfYw==", null, false, "6db86271-575c-4f8b-8642-47f63762ce91", false, "Admin" },
                    { "Test2729373937898-329332ndyvyuhvjjhf8e4", 0, "b41c19d1-94b2-4881-8a94-f5e92b0c2795", "Test@gmail.com", true, true, false, null, "TEST@GMAIL.COM", "TESTUSER", "AQAAAAEAACcQAAAAEEwASEo/WiBf1dQ3krdMHvrRayfa/RSWjfK5QeLMKocU2P6kstU9eIP8b0djna5FOg==", null, false, "18bc73f3-9291-4709-afda-35884f6a61c4", false, "TestUser" },
                    { "Test27293wdqwdqw73937898-329332ndyvyuhvjjhf8e4", 0, "70fe8dbf-f72c-4279-a7ae-93fc635a9b71", "Test2@gmail.com", true, true, false, null, "TEST2@GMAIL.COM", "TESTUSER2", null, null, false, "e88fed4f-12c7-47b3-b9f2-5ec10913fc4c", false, "TestUser2" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "Adminkahsakjsajkf99s86as79", "Admin2729083033937898-329332nduyvugjvjhf8e4" });
